...
def show_3d_point_clouds(shapes, is_missing_part):
    ...
    video_show3d_balls.showpoints(shapes, c_gt=colors, ballradius=8, normalizecolor=False, background=[255, 255, 255])
    # ground truth
    # video_show3d_balls.showpoints(shapes,  ballradius=8, normalizecolor=False, background=[255, 255, 255])
