...
encoder_img = torch.load('encoder_img_test.pkl', map_location='cuda:0')
decoder_pc_part = torch.load('decoder_pc_test.pkl', map_location='cuda:0')
...
for batch_idx, batch in enumerate(train_iter):
    ...
    total_loss = task_loss(IN_Mask,outputs['projs']) 
    ...
    #     plt.savefig(snapshot_folder+'//results_4096_test//'+str(batch_idx)+'_'+str(i) +'_image.png')
    #     plt.close()
    ...
    #     plt.imshow(frame)
    #     plt.axis('off')
    #     plt.savefig(snapshot_folder+'//results_4096_test//'+str(batch_idx)+'_'+str(i) +'_point.png')
    #     plt.close()
