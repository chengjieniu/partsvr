...
model_folder = os.path.join("testmodel//car_pose_unsuper")
...
for batch_idx, batch in enumerate(train_iter):
    ...
    # for i in range(0, 150):
        ...
        # plt.savefig(snapshot_folder+'//result_image_chair_unsuper_test//'+str(batch_idx)+'_'+str(i) +'_image.png')
        # plt.close()
        # print(batch_idx)
        ...
        # plt.imshow(frame)
        # plt.axis('off')
        # plt.savefig(snapshot_folder+'//result_image_chair_unsuper_test//'+str(batch_idx)+'_'+str(i) +'_point.png')
        # plt.close()

        # frame = show_balls1.show_3d_point_clouds(outputs['points_1'][i].cpu().detach().numpy(), False)
        # plt.imshow(frame)
        # plt.axis('off')
        # plt.savefig(snapshot_folder+'//result_image_chair_unsuper_test//'+str(batch_idx)+'_'+str(i) +'_point1.png')
        # plt.close()
...
print('done')
scio.savemat(out_dir + synth_set + 'pred_test_code_unsuper_test', {'name': points_pred['name'], 'points': points_pred['points'], \
