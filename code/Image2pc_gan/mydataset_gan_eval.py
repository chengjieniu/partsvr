...
class myDataset(data.Dataset):
    def __init__(self, dir, transform=None):
        #self.dir = dir
        # input_data_src = h5py.File('/home/ncj/Desktop/ncj/Image2pc/code/data/torch_data/03001627traintrain_cam.h5') #test campos fixed
        ...
        # input_data_src = h5py.File('data/torch_data/02691156test_cam.h5')
        # input_data_src = h5py.File('data/torch_data/02958343test_cam.h5')
