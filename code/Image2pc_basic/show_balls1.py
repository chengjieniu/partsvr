...
def show_3d_point_clouds(shapes, is_missing_part):
    ...
    frame = show3d_balls1.showpoints_frame(shapes, c_gt=colors, ballradius=8, normalizecolor=False, background=[255, 255, 255])
    return frame
